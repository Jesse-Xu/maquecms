<?php /*a:3:{s:51:"G:\www2\cms2\application\admin\view\link\lists.html";i:1545324538;s:52:"G:\www2\cms2\application\admin\view\public\base.html";i:1543161944;s:52:"G:\www2\cms2\application\admin\view\public\head.html";i:1541778938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-form">
  ...
  <div class="layui-inline">
    ...
    <a href="javascript:LayerOpen('<?php echo url('link/add'); ?>');" class="layui-btn layui-btn-normal" >添加链接</a>
  </div>
...
layui.use(['table','laydate','form'], function(){
  ...
  table.on('tool(table)', function(obj){
    ...
    if(obj.event === 'del'){
      ...
      Delete("<?php echo Url('del'); ?>",{'linkid': data.linkid},obj);

    } else if(obj.event === 'edit'){
        LayerOpen("edit/linkid/"+data.linkid);
  ...
  form.on('switch(status)', function(data){
     ...
     Status("<?php echo url('up'); ?>",{'status':data.elem.checked,'linkid':data.value});
