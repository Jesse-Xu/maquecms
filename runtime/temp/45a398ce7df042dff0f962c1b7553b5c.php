<?php /*a:3:{s:54:"G:\www2\cms2\application\admin\view\news\newsedit.html";i:1542902128;s:52:"G:\www2\cms2\application\admin\view\public\base.html";i:1543161944;s:52:"G:\www2\cms2\application\admin\view\public\head.html";i:1541778938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux" style="padding-top: 0px !important; ">
                      ...
                      <img src="<?php echo htmlentities($info['thumb']); ?>" id="thumb" class="content-photos">
                      <?php endif; ?>
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <input type="text" name="url" requplaceholder="请输入跳转链接" autocomplete="off" class="layui-input" value="<?php echo htmlentities($info['url']); ?>" placeholder="请输入跳转链接">
                    </div>
                  </div>
            </div>
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                      <textarea name="abstract"  placeholder="请输入文章关键字" autocomplete="off" class="layui-textarea"  ><?php echo htmlentities($info['abstract']); ?></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">seo文章描述</label>
                    <div class="layui-input-block">
                      <textarea name="description"  placeholder="请输入文章描述" autocomplete="off" class="layui-textarea"  ><?php echo htmlentities($info['description']); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
                <div class="layui-form-item">
                  ...
                  <?php if(!(empty($info['photos']) || (($info['photos'] instanceof \think\Collection || $info['photos'] instanceof \think\Paginator ) && $info['photos']->isEmpty()))): foreach($info['photos']['name'] as $k=>$v): ?>

                        <div class="layui-form-item">
                            <label class="layui-form-label"></label>
                            <div class="layui-input-inline" style="width: 100px;">
                            <input type="text" name="photos[name][]" lay-verify="required" placeholder="图片名称" autocomplete="off" class="layui-input" placeholder="文件名称" value="<?php echo htmlentities($info['photos']['name'][$k]); ?>">
                            <input type="hidden" name="photos[path][]" placeholder="图片地址"></div>
                            <img src="<?php echo htmlentities($info['photos']['path'][$k]); ?>" class="content-photos" value="<?php echo htmlentities($info['photos']['path'][$k]); ?>">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-form-item" id="filedata" >
                        <?php if(!(empty($info['files']) || (($info['files'] instanceof \think\Collection || $info['files'] instanceof \think\Paginator ) && $info['files']->isEmpty()))): foreach($info['files']['name'] as  $k=>$v): ?>
                        <div class="layui-form-item">
                            <label class="layui-form-label"></label>
                            <input type="hidden" name="files[src][]" value="<?php echo htmlentities($info['files']['src'][$k]); ?>">
                            <input type="hidden" name="files[name][]" value="<?php echo htmlentities($info['files']['name'][$k]); ?>">
                            <a href="<?php echo htmlentities($info['files']['src'][$k]); ?>" target="_blank"><?php echo htmlentities($info['files']['name'][$k]); ?></a>&nbsp;&nbsp;
                ...
                <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline"   lay-filter="author">
                           ...
                           <?php if($info['authorid'] == ''): if(!(empty($authorlist) || (($authorlist instanceof \think\Collection || $authorlist instanceof \think\Paginator ) && $authorlist->isEmpty()))): foreach($authorlist as $v): ?>
                              ...
                              <?php endforeach; ?>
                              <?php endif; else: if(!(empty($authorlist) || (($authorlist instanceof \think\Collection || $authorlist instanceof \think\Paginator ) && $authorlist->isEmpty()))): foreach($authorlist as $v): ?>
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        <input type="radio" name="status" value="1" title="上架" <?php if(($info['status'] == '') or ($info['status'] == '1')): ?>checked<?php endif; ?>>
                        <input type="radio" name="status" value="0" title="下架" <?php if($info['status'] == '0'): ?>checked<?php endif; ?>>
                        <input type="radio" name="status" value="-1" title="草稿" <?php if($info['status'] == '-1'): ?>checked<?php endif; ?>>
                      </div>
                    </div>
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block" lay-filter="iscomment">
                        <?php if($info['newsid'] == ''): ?>
                          <input type="radio" name="iscomment" value="1" title="启用" <?php if($modelinfo['iscomment'] != '0'): ?>checked<?php endif; ?> >
                          <input type="radio" name="iscomment" value="0" title="禁用" <?php if($modelinfo['iscomment'] == '0'): ?>checked<?php endif; ?>>
                        <?php else: ?>
                          <input type="radio" name="iscomment" value="1" title="启用" <?php if($info['iscomment'] != '0'): ?>checked<?php endif; ?> >
                          <input type="radio" name="iscomment" value="0" title="禁用" <?php if($info['iscomment'] == '0'): ?>checked<?php endif; ?> >
                        <?php endif; ?>
                      </div>
                    </div>
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        <input type="checkbox" name="hot" title="推荐" <?php if($info['hot'] == '1'): ?>checked<?php endif; ?>>
                        <input type="checkbox" name="top" title="置顶" <?php if($info['top'] == '1'): ?>checked<?php endif; ?>>
                      </div>
                    </div>
