<?php /*a:3:{s:55:"G:\www2\cms2\application\admin\view\auth\adminedit.html";i:1542725783;s:52:"G:\www2\cms2\application\admin\view\public\base.html";i:1543161944;s:52:"G:\www2\cms2\application\admin\view\public\head.html";i:1541778938;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<form class="layui-form" action="" method="POST">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width:350px;">
            ...
            <input type="hidden" name="adminid" value="<?php echo htmlentities($info['adminid']); ?>">

            <input type="text" name="nickname" required lay-verify="required" placeholder="名称" autocomplete="off" class="layui-input"  value="<?php echo htmlentities($info['nickname']); ?>">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width:350px;">
            ...
            <input type="text" name="username" required lay-verify="required" placeholder="排序" autocomplete="off" class="layui-input"  value="<?php echo htmlentities($info['username']); ?>">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline" style="width:350px;">
            ...
            <?php else: ?>
              ...
              <input type="password" name="password"  placeholder="请输入密码" autocomplete="off" class="layui-input"  value="<?php echo htmlentities($info['password']); ?>">
            ...
            <select name="roleid" lay-verify="required" >
              ...
              <option value="">请选择角色</option>
                ...
                <?php foreach($rolelist as $v): ?>
                  ...
                  <option value="<?php echo htmlentities($v['roleid']); ?>" <?php if($info['roleid'] == $v['roleid']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
