<?php /*a:3:{s:54:"G:\www2\cms2\application\admin\view\news\newsinfo.html";i:1541609835;s:52:"G:\www2\cms2\application\admin\view\public\base.html";i:1541603122;s:52:"G:\www2\cms2\application\admin\view\public\head.html";i:1541608406;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form class="layui-form" action="" method="POST">
       <div class="layui-col-md9" style="border-right:1px solid #eee;padding-right:10px;">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="keyword"  placeholder="请输入文章关键字" autocomplete="off" class="layui-input"  value="<?php echo htmlentities($info['keyword']); ?>">
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">seo文章描述</label>
            <div class="layui-input-block">
              <input type="text" name="description"  placeholder="请输入文章描述" autocomplete="off" class="layui-input"  value="<?php echo htmlentities($info['description']); ?>">
            </div>
          </div>
...
<script type="text/javascript">
    ...
    $.post(location.href,JSON.stringify(data.field),function(res){
      console.log(res);
    },'json');
